...
import 'widgets/backup_password_dialogs.dart';
...
class _ExportScreenState extends State<ExportScreen> {
  ...
  /// A one-time, no-account text summary the user sends themselves through
  /// the OS share sheet. Real live pairing exists now too — see
  /// `PartnerModeScreen`, reachable from Settings — but this stays: not
  /// everyone wants an account just to send their partner today's status
  /// once, and this needs neither sign-in nor Firebase to work.
            ...
            child: ListView(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  label: Text(l10n.cloudBackupEntry),
                ),
                const SizedBox(height: 32),
                Text(
                  l10n.partnerShareTitle,
                  style: Theme.of(context).textTheme.titleMedium,
                ),
                const SizedBox(height: 8),
                ...
                const SizedBox(height: 32),
                Text(
                  l10n.exportDoctorReportHeading,
                  style: Theme.of(context).textTheme.titleMedium,
                ),
                const SizedBox(height: 8),
