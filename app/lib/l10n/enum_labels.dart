...
String symptomLabel(AppLocalizations l10n, Symptom symptom) =>
    switch (symptom) {
      ...
      Symptom.migraine => l10n.symptomMigraine,
      Symptom.highFever => l10n.symptomHighFever,
      Symptom.neckPain => l10n.symptomNeckPain,
      Symptom.shoulderPain => l10n.symptomShoulderPain,
      Symptom.limbPain => l10n.symptomLimbPain,
      Symptom.muscleAche => l10n.symptomMuscleAche,
      Symptom.chills => l10n.symptomChills,
      Symptom.nightSweats => l10n.symptomNightSweats,
      Symptom.hotFlashes => l10n.symptomHotFlashes,
      Symptom.weightGain => l10n.symptomWeightGain,
      Symptom.constipation => l10n.symptomConstipation,
      Symptom.diarrhea => l10n.symptomDiarrhea,
      Symptom.indigestion => l10n.symptomIndigestion,
      Symptom.gasPain => l10n.symptomGasPain,
      Symptom.feelingUnwell => l10n.symptomFeelingUnwell,
      Symptom.itching => l10n.symptomItching,
      Symptom.troubleFocusing => l10n.symptomTroubleFocusing,
      Symptom.forgetfulness => l10n.symptomForgetfulness,
    };
...
String moodLabel(AppLocalizations l10n, Mood mood) => switch (mood) {
  ...
  Mood.excited => l10n.moodExcited,
  Mood.hopeful => l10n.moodHopeful,
  Mood.proud => l10n.moodProud,
  Mood.disappointed => l10n.moodDisappointed,
  Mood.confident => l10n.moodConfident,
  Mood.surprised => l10n.moodSurprised,
  Mood.indifferent => l10n.moodIndifferent,
  Mood.peaceful => l10n.moodPeaceful,
  Mood.inLove => l10n.moodInLove,
  Mood.shy => l10n.moodShy,
  Mood.playful => l10n.moodPlayful,
  Mood.exhausted => l10n.moodExhausted,
  Mood.lonely => l10n.moodLonely,
  Mood.overwhelmed => l10n.moodOverwhelmed,
  Mood.grateful => l10n.moodGrateful,
  Mood.nostalgic => l10n.moodNostalgic,
};
